  ...
  return (
    <form onSubmit={handleSubmit(data =>
      ...
      <div className="mb-3">
        ...
        <input {...register('description')} id="description" type="text" className="form-control" aria-label="Description" />
      ...
      <div className="mb-3">
        ...
        <input {...register('amount', { valueAsNumber: true})} id="amount" type="number" className="form-control" aria-label="Amount" />
      ...
      <div className="mb-3">
        ...
        <select {...register('category')} id="category" className="form-select" aria-label="Select expense category">
